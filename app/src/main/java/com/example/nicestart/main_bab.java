...
public class main_bab extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myfab.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Toast.makeText(main_bab.this, "Fab Clicked", Toast.LENGTH_SHORT).show();
            }
        });
        //click event en el bottom app bar
        bottomAppBar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                if(item.getItemId()==R.id.heart){
                    Toast.makeText(main_bab.this, "Added to favorites", Toast.LENGTH_SHORT).show();
                } else if (item.getItemId()==R.id.search) {
                    Toast.makeText(main_bab.this, "Beginning search", Toast.LENGTH_SHORT).show();
                }
                return false;
            }
        });
        //click event en el menu hamburguer
    ...
    private void showBottomSheetDialog() {
        ...
        option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(main_bab.this, "Settings clicked", Toast.LENGTH_SHORT).show();
        ...
        option2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(main_bab.this, "About clicked", Toast.LENGTH_SHORT).show();
                bottomSheetDialog.dismiss();
            }
        });
        ...
        option3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(main_bab.this, "Logout clicked", Toast.LENGTH_SHORT).show();
                bottomSheetDialog.dismiss();
            }
        });
    }
